      ...
      >
        <div className="fluent-hero-card relative overflow-visible p-7 md:p-8">
          ...
          >
            ...
            <span>{proxyType === "direct" ? "Proxy Settings" : `Proxy: ${proxyType.toUpperCase()}`}</span>
          </button>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-4 gap-4">
              <div className="col-span-3 relative z-20">
                ...
                <input
                  ...
                  className="w-full ui-input-base py-3 pl-10 pr-10"
                />
                ...
                <AnimatePresence>
                  {showHistory && history.length > 0 && (
                    <motion.div
                      ...
                      className="absolute left-0 right-0 top-full mt-2 overflow-hidden rounded-[1rem] border border-slate-100/50 bg-white/80 backdrop-blur-xl shadow-[0_28px_50px_-30px_rgba(15,23,42,0.24)]"
                    >
                      <div className="max-h-60 overflow-y-auto custom-scrollbar">
                        <div className="px-3 py-2 bg-slate-50/50 border-b border-slate-100/50 text-xs font-semibold text-slate-400 uppercase tracking-wider flex items-center gap-2">
                          <History size={12} />
                          <span>最近连接</span>
                        </div>
              ...
              <div className="col-span-1 relative">
                <input
                  ...
                  className="w-full ui-input-base px-4 py-3 text-center"
                />
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full ui-input-base py-3 pl-10 pr-4"
              />
            </div>
