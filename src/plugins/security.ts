...
export const securityCommands: PluginCommand[] = [
  ...
  { 
    ...
    icon: FileText, 
    parserType: 'authLog',
    parserArgs: { logKind: 'login_success' } 
  },
  { 
    id: 'fail_login', 
    category: 'security', 
    ...
    icon: Activity, 
    parserType: 'authLog',
    parserArgs: { logKind: 'login_failed' } 
  },
  { 
    id: 'sudo_audit_log', 
    category: 'security', 
  ...
  { 
    ...
    icon: FileText, 
    parserType: 'authLog',
    parserArgs: { logKind: 'system_error' } 
  },
  { 
    id: 'web_error_log', 
    category: 'security', 
